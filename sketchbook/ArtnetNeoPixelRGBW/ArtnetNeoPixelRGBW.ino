...
// Neopixel settings
const int numLeds = 15; // change for your setup
...
// Artnet settings
Artnet artnet;
const int startUniverse = 4; // CHANGE FOR YOUR SETUP most software this is 1, some software send out artnet first universe as 0.
